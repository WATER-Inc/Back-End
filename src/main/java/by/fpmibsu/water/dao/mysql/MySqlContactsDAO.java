...
import by.fpmibsu.water.dao.entity.Contacts;
...
public class MySqlContactsDAO extends AbstractJDBCDao<Contacts, String> {

    private class PersistContacts extends Chat {
    ...
    protected List<Chat> parseResultSet(ResultSet rs) throws PersistException {
        ...
        try {
            while (rs.next()) {
                MySqlChatDAO.PersistChat chat = new MySqlChatDAO.PersistChat();
